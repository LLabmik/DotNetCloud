...
**Batch 4 server-side complete.** Tasks 4.1–4.5 server implementations done:
- Issue #41 (Task 4.1): Case-sensitivity conflict detection — client-side only (complete)
- Issue #42 (Task 4.2): POSIX permission metadata — complete both sides
