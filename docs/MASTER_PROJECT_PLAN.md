...
- ✓ `DotNetCloud.UI.Web` Razor Class Library (server-side root, SSR auth pages, layouts)
  ...
  - ✓ Files upload queue eagerly buffers selected browser files to avoid reader-lifecycle failures during sequential multi-file uploads
