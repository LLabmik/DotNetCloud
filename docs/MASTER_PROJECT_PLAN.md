...
**Tasks:**
- ✓ Add chat notification popups with message preview and channel-aware titles (current implementation: Windows balloon tip + Linux libnotify)
