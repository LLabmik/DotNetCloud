...
| `AddPhotosUiServices` | `Photos.Data` | `IPhotoService`, `IAlbumService`, `IPhotoShareService`, `IPhotoEditService`, `ISlideshowService`, `IPhotoThumbnailService`, `IPhotoGeoService`, `IPhotoIndexingCallback`, `PhotoMetadataService`, `PhotosScanProgressState`                                                                                                                                                                 |
