...
public class DependencyServiceTests
{
    ...
    {
        var cardA = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "Card A");
        var cardB = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "Card B");
    ...
    {
        var cardA = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "A");
        var cardB = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "B");
    ...
    public async Task AddDependency_CycleDetection_Throws()
    {
        var cardA = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "A");
        var cardB = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "B");
        var cardC = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "C");
    ...
    public async Task AddDependency_RelatesTo_SkipsCycleCheck()
    {
        ...
        var cardC = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "C");
        var cardD = await TestHelpers.SeedCardAsync(_db, _list.Id, _caller.UserId, "D");
