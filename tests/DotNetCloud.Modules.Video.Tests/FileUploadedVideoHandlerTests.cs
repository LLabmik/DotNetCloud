...
public class FileUploadedVideoHandlerTests
{
    ...
    public async Task HandleAsync_VideoMimeType_CallsIndexingCallback()
    {
        ...
        callbackMock.Verify(c => c.IndexVideoAsync(
            evt.FileNodeId, evt.FileName, evt.MimeType!, evt.Size,
                evt.UploadedByUserId, evt.StoragePath, It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task HandleAsync_NonVideoMimeType_DoesNotCallCallback()
    {
        ...
        callbackMock.Verify(c => c.IndexVideoAsync(
            ...
            It.IsAny<long>(), It.IsAny<Guid>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task HandleAsync_CallbackThrows_DoesNotPropagate()
    {
        ...
        callbackMock.Setup(c => c.IndexVideoAsync(
            It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string>(),
            It.IsAny<long>(), It.IsAny<Guid>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()))
    ...
    public async Task HandleAsync_CaseInsensitiveMimeType_StillMatches()
    {
        ...
        callbackMock.Verify(c => c.IndexVideoAsync(
            It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string>(),
            It.IsAny<long>(), It.IsAny<Guid>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Once);
    }
