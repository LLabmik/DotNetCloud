...
internal static class SetupCommand
{
    ...
    private static async Task<int> RunSetupWizardAsync()
    {
        ...
        ConsoleOutput.WriteStep(1, 8, "Database Configuration");
        ...
        ConsoleOutput.WriteStep(2, 8, "Verifying Database Connection");
        ...
        // Step 3: Admin user
        ConsoleOutput.WriteStep(3, 8, "Admin User Configuration");
        ...
        ConsoleOutput.WriteStep(4, 8, "Multi-Factor Authentication");
        ...
        // Step 5: Organization
        ConsoleOutput.WriteStep(5, 8, "Organization Setup");
        config.OrganizationName = ConsoleOutput.Prompt("Organization name", "My Organization");

        // Step 6: TLS/HTTPS
        ConsoleOutput.WriteStep(6, 8, "TLS/HTTPS Configuration");
        ...
        ConsoleOutput.WriteStep(7, 8, "Module Selection");
        ...
        ConsoleOutput.WriteStep(8, 8, "Data Directories");
