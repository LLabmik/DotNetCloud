        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PhotoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CameraMake = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CameraModel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LensModel = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    FocalLengthMm = table.Column<double>(type: "float", nullable: true),
                    Aperture = table.Column<double>(type: "float", nullable: true),
                    ShutterSpeed = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Iso = table.Column<int>(type: "int", nullable: true),
                    FlashFired = table.Column<bool>(type: "bit", nullable: true),
                    Orientation = table.Column<int>(type: "int", nullable: true),
                    Latitude = table.Column<double>(type: "float", nullable: true),
                    Longitude = table.Column<double>(type: "float", nullable: true),
                    AltitudeMetres = table.Column<double>(type: "float", nullable: true),
