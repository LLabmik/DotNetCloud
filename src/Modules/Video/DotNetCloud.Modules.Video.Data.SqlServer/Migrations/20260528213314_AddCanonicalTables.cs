        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TmdbTitle = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    ExternalPosterHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailPosterHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    HasExternalPoster = table.Column<bool>(type: "bit", nullable: false),
                    ExternalPosterHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    EmbeddedTitle = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    EmbeddedImdbId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    EmbeddedTmdbId = table.Column<int>(type: "int", nullable: true),
                    EmbeddedDate = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    EmbeddedLanguage = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SeriesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VideoContentHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
