...
public static class MaterialSvgIcons
{
    ...
    private static readonly Dictionary<string, string> s_paths = new()
    {
        ...
        ["notifications_none"] = "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zm-2 1H8v-6c0-2.48 1.51-4.5 4-4.5s4 2.02 4 4.5v6z",
        ["notifications_active"] = "M7.58 4.08l-2.11-1.9-1.42 1.42L6.16 5.5C4.82 6.9 4 8.83 4 11v5l-2 2v1h20v-1l-2-2v-5c0-2.17-.82-4.1-2.16-5.5l2.11-1.9-1.42-1.42-2.11 1.9C14.79 3.52 13.45 3 12 3s-2.79.52-3.87 1.4l-.55-.32zM12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2z",
        ...
        ["contacts"] = "M20 0H4v2h16V0zM4 24h16v-2H4v2zM20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 2.75c1.24 0 2.25 1.01 2.25 2.25s-1.01 2.25-2.25 2.25S9.75 10.24 9.75 9 10.76 6.75 12 6.75zM17 17H7v-1.5c0-1.67 3.33-2.5 5-2.5s5 .83 5 2.5V17z",
        ...
        ["task_alt"] = "M22 5.18L10.59 16.6l-4.24-4.24 1.41-1.41 2.83 2.83 10-10L22 5.18zM12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8c1.57 0 3.04.46 4.28 1.25l1.44-1.44A9.9 9.9 0 0 0 12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10c0-1.19-.22-2.33-.6-3.39l-1.44 1.44c.03.32.04.65.04.95 0 4.41-3.59 8-8 8z",
    };
}
